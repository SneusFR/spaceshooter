...
class Medical extends SpriteComponent with HasGameRef<GameManager>, HasHitboxes, Collidable {
  final double _speed = 250;
  var hitboxRectangle = HitboxRectangle();
  final Function(Vector2) onTouch;
  Medical(this.onTouch);


  @override
  Future<void>? onLoad() async {
    var spriteSheet = SpriteSheet(
        image: await Images().load('medical.png'), srcSize: Vector2(500.0, 500.0));
